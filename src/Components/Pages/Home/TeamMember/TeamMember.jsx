                    ...
                    <div className="grid w-full grid-cols-1 gap-x-6 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
                        {
                            ...
                            <div className="flex flex-col items-center">
                                ...
                                <p className="text-sm dark:text-gray-400">{card.designation}</p>
                                <div className="flex mt-2 space-x-2 h-auto max-w-lg transition-all duration-300 rounded-lg cursor-pointer filter grayscale hover:grayscale-0">
                                    <a rel="noopener noreferrer" href="#" title="Twitter" className="dark:text-blue-400">
                                    ...
                                    <a rel="noopener noreferrer" href="#" title="LinkedIn" className="dark:text-green-600">
                                    ...
                                    <a rel="noopener noreferrer" href="#" title="GitHub" className="dark:text-red-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-4 h-4">
