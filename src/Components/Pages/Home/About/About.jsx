            ...
            <div className="hero min-h-screen ">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }} className="max-w-sm p-6  border rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            <FaAddressCard className='h-8 w-12 text-blue-600'></FaAddressCard>
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight  dark:text-white">Member Card</h5>
                            </a>
                            <p className="mb-3 font-normal  dark:text-gray-400">Go to this step by step guideline process on how to certify for your weekly benefits:</p>
                        ...
                        <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }} className="max-w-sm p-6 border rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight  dark:text-white">High Quality Books</h5>
                            </a>
                            <p className="mb-3 font-normal dark:text-gray-400">Go to this step by step guideline process on how to certify for your weekly benefits:</p>
                            <a href="#" className="inline-flex items-center text-blue-600 hover:underline">
                                See our guideline
                        ...
                        <motion.div whileHover={{ scale: 1.1, transition: { duration: 0.3 } }} className="max-w-sm p-6 border rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight dark:text-white">Free All Books</h5>
                            </a>
                            <p className="mb-3 font-normal dark:text-gray-400">Go to this step by step guideline process on how to certify for your weekly benefits:</p>
                            <a href="#" className="inline-flex items-center text-blue-600 hover:underline">
                                See our guideline
                        ...
                        <motion.div whileHover={{ scale: 1.1,  transition: { duration: 0.3 } }} className="max-w-sm p-6 border rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <a href="#">
                                <h5 className="mb-2 text-2xl font-semibold tracking-tight dark:text-white">Up To Date Books</h5>
                            </a>
                            <p className="mb-3 font-normal dark:text-gray-400">Go to this step by step guideline process on how to certify for your weekly benefits:</p>
                            <a href="#" className="inline-flex items-center text-blue-600 hover:underline">
                                See our guideline
