...
const Bookdetails = () => {
    ...
    return (
        <>
            ...
            <h2 className="text-4xl font-bold text-center py-12">Details: <span className="text-blue-700">{book}</span></h2>
            {
                                ...
                                <div class="flex flex-col justify-between p-4 leading-normal">
                                    ...
                                    <div className="  items-center py-4 ">
                                        <Rating
                                            ...
                                            readOnly
                                        />
                                        <h5 class="text-sm font-normal text-gray-700 dark:text-gray-400"><span className="font-bold">Short Description: </span>{description?.slice(0, 100)}<span className="font-bold text-blue-700">...</span></h5>
                                                    ...
                                                    <div className="md:flex mb-8">
                                                        <div className="form-control md:w-1/2 ml-4">
                                                            ...
                                                            <label className="input-group">
                                                                ...
                                                                <input type="text" name="user" placeholder="User Name" defaultValue={user?.displayName} className="input input-bordered w-full" />
                                                            </label>
                                                        </div>
                                                        <div className="form-control md:w-1/2 ml-4">
                                                            <label className="label">
